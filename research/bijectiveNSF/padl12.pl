...
add([],Y,Y).
add([X|Xs],[],[X|Xs]).
add([[]|RX],[[]|RY],Z):-add(RX,RY,R),s([[]|R],Z).
add([[]|RX],[[C|Cs]|Ds],[[]|S]):-p([[C|Cs]|Ds],[[]|RY]),add(RX,RY,R),s(R,S).
add([[A|As]|Bs],[[]|RY],[[]|S]):-p([[A|As]|Bs],[[]|RX]),add(RX,RY,R),s(R,S).
add([[A|As]|Bs],[[C|Cs]|Ds],Z):-p([[A|As]|Bs],[[]|RX]),p([[C|Cs]|Ds],[[]|RY]),
   add(RX,RY,R),s(R,S),s([[]|S],Z).
