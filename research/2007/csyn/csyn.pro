...
synthesize_circuit(NbOfBits:OutputSpec, PIs:LeafDag:OutputSpec,Size,Steps):-!,
  ...
  synthesize_leaf_dag(UniqueBitstringIntVars,NbOfBits,
     PIs:LeafDag=OutputSpec,Size,Steps).  
...
synthesize_circuit(BooleanExpression, PIs:LeafDag:OutputSpec,Size,Steps):-
  vars_of(BooleanExpression,UniqueBitstringIntVars),
...
% unique bitstring integer represented variables ars and a truth
